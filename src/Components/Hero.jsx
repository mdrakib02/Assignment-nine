...
export default function Hero() {
  return (
    <div className='flex items-center flex-col gap-y-4 py-16'>
        ...
        <p className='text-base text-gray-400 text-center w-full md:w-3/6 mx-auto'>GreenNest helps you choose, grow, and care for beautiful indoor plants that purify your air and elevate your everyday living.</p>
